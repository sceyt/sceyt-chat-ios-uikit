...
open class ChannelMemberRoleListVC: ViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    open lazy var viewModel = instance(of: ChannelMemberRolesVM.self).init()
    ...
    open override func setup() {
        ...
        tableView.register(instance(of: MemberRolesCell.self))
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(for: indexPath, cellType: instance(of: MemberRolesCell.self))

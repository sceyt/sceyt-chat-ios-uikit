//
//  EditMessageBodyFormatter.swift
//  SceytChatUIKit
//
...
open class EditMessageBodyFormatter: EditMessageBodyFormatting {
    
    public init() {}
    
    open func format(_ messageBodyAttributes: EditMessageBodyFormatterAttributes) -> NSAttributedString {
        ...
        var text = messageBodyAttributes.layoutModel.attributedView.content.string

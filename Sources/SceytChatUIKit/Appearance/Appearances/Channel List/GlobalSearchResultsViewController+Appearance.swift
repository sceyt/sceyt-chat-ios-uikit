...
extension GlobalSearchResultsViewController {
    ...
    public static var defaultAppearance = Appearance(
        ...
        messagesSeparatorViewAppearance: .init(
            reference: Components.separatorHeaderView.appearance,
            title: L10n.Search.Category.messages
        ),
    ...
    public class Appearance: ChannelSearchResultsBaseViewController.Appearance {
        ...
        @Trackable<Appearance, SeparatorHeaderView.Appearance>
        public var messagesSeparatorViewAppearance: SeparatorHeaderView.Appearance
        ...
        public init(
            ...
            messagesSeparatorViewAppearance: SeparatorHeaderView.Appearance,
            tabBarAppearance: CategoryTabBar.Appearance,
            ...
            self._messagesSeparatorViewAppearance = Trackable(value: messagesSeparatorViewAppearance)
        ...
        public init(
            ...
            messagesSeparatorViewAppearance: SeparatorHeaderView.Appearance? = nil,
            ...
            self._messagesSeparatorViewAppearance = Trackable(reference: reference, referencePath: \.messagesSeparatorViewAppearance)
            ...
            if let messagesSeparatorViewAppearance { self.messagesSeparatorViewAppearance = messagesSeparatorViewAppearance }

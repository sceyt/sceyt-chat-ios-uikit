...
internal enum Assets {
  ...
  internal static let actionPin = ImageAsset(name: "action_pin")
  ...
  internal static let actionUnpin = ImageAsset(name: "action_unpin")
  ...
  internal static let chatShowInChat = ImageAsset(name: "chat_show_in_chat")
  internal static let chatUnblock = ImageAsset(name: "chat_unblock")
  internal static let chatUnpin = ImageAsset(name: "chat_unpin")
  internal static let messagePinned = ImageAsset(name: "message_pinned")
  internal static let pinnedMessageNavigate = ImageAsset(name: "pinned_message_navigate")
  internal static let pinnedMessagesIndicator = ImageAsset(name: "pinned_messages_indicator")

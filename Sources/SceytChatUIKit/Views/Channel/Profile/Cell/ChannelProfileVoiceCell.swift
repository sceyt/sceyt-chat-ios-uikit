...
open class ChannelProfileVoiceCell: CollectionViewCell {
    typealias Layouts = ChannelVoiceListView.Layouts
...
public extension ChannelProfileVoiceCell {
    enum Event {
